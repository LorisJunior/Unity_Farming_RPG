...
public class AnimationOverrides : MonoBehaviour
{
    ...
    public void ApplyCharacterCustomisationParameters(List<CharacterAttribute> characterAttributesList)
    {
        foreach(CharacterAttribute characterAttribute in characterAttributesList)
        {
            ...
            List<KeyValuePair<AnimationClip, AnimationClip>> animsKeyValuePartList = new List<KeyValuePair<AnimationClip, AnimationClip>>();
            ...
            foreach (AnimationClip animationClip in animationsList)
            {
                ...
                if (foundAnimation)
                {
                    ...
                    if (foundSwapAnimation)
                    {
                        ...
                        animsKeyValuePartList.Add(new KeyValuePair<AnimationClip, AnimationClip>(animationClip, swapAnimationClip));
                    }
                }
            }

            aoc.ApplyOverrides(animsKeyValuePartList);
